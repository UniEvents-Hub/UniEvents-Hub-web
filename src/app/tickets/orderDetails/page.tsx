...
import { getUserOrderDetails } from "@/app/services/User/user-service";
                ...
                eventDetails ?
                    ...
                    <div className={`flex flex-row md:pl-[200px] px-[60px] w-full overflow-hidden no-scrollbar ${backgroundGradiant} `}>
                        <div className="w-[20%] bg-gray-200 bg-opacity-100 px-[20px] pt-10  ">
                            ...
                            <h1 className="text-#1C1C1C text-[28px] text-bold text-left mt-4">Ticket PDF</h1>

                            <div
                                onClick={() => { window.open(`${Urls.BASE_URL}${orderDetails.ticket_pdf}`) }}
                                className='flex items-center md:py-0 py-2 mt-2'>
                                ...
                                <a href={orderDetails && orderDetails.ticket_pdf ? `${Urls.BASE_URL}${orderDetails.ticket_pdf}` : '/'} target="_blank" rel="noopener noreferrer" download>
                                    <div className='flex flex-col items-start ml-2'>

                                        <span className="text-[14px] text-blue-500  cursor-pointer hover:underline">Download ticket</span>
                                    ...
                                    <div className="flex flex-col bg-white rounded-[10px] pl-0 pt-4">
                                        ...
                                        <div className={`h-[200px] w-full rounded-[10px] mt-[-20px] ml-[0px] culture-gradient-background opacity-100`}>
                                            <img
                                                ...
                                                alt="Description of your image"
                                                className="w-full h-[200px] rounded-[2px] object-cover" />
                                        </div>
                                    ...
                                    <div className="w-[100%] flex flex-col bg-white rounded-lg pl-6 mb-10">
                                        ...
                                        <div className="flex flex-col bg-white rounded-[10px] pl-0 pt-0">
                                            <div className="flex justify-between mx-0 mt-0">
                                                <div className="flex flex-col items-start">
                                                    <span className="mb-[6px] text-[16px] font-normal text-green-500 dark:text-gray-400">Order ID: {orderDetails && orderDetails?.order_id}</span>
                                                </div>
                                            ...
                                            <div className="flex justify-between items-center mr-10 mt-6 mb-8">
                                                <div className='flex items-center md:py-0 py-2 mt-0 '>
                                                    ...
                                                    <div className='flex flex-col items-start ml-[14px]'>
                                                        ...
                                                        <span className="text-[12px]">{orderDetails && orderDetails?.ticket_number ? orderDetails?.ticket_number : 1}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div className='flex items-center md:py-0 py-2'>
                                                    ...
                                                    <div className='flex flex-col items-start ml-[14px]'>
                                                        ...
                                                        <span className="text-[12px]">CAD ${orderDetails && orderDetails?.total_cost ? orderDetails?.total_cost : 10.00}</span>
