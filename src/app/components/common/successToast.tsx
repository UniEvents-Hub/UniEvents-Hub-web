...
export default function SuccessToast({ closeModal, message }: any) {
    return (
        <div id="toast-success"
            className=" fixed top-6 left-[40%] flex justify-center items-center max-w-[700px] p-4 mb-4 text-white bg-green-600 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
            role="alert">
            <div
